...
label_paragraph = Label(paragraph_frame , text=paragraph_list[0] , fg="black" , bg="grey80" ,wraplength=1450 , font="aeriel 18 bold")
label_paragraph.place(x=0 , y=0)

textarea_frame = Frame(typing_test , bg="grey80" , width=1000 , height=400)
textarea_frame.place(x=200 ,y=250)

textarea = Text(textarea_frame , bg="grey80" , fg="black" , width=76 , height=400 ,borderwidth=7 , font="aerial 18 bold" , wrap="word" , relief=GROOVE , state=DISABLED)
...
button_frame = Frame(typing_test , bg="red" , width=230 , height=400 , borderwidth=5)
button_frame.place(x=1210 , y=250)

startButton = Button(button_frame, text="<< Start >>" , width=10 , height=2  , fg="White" , bg="black" , border=10 , font="monospace 10 bold" , command=start)
startButton.place(x=50 , y=120)

exitButton = Button(button_frame , text=">> Exit <<" , width=10 , height=2 , command=typing_test.destroy , fg="white" , bg="black" , border=10 , font="monospace 10 bold")
exitButton.place(x=50 , y=200)


button_frame_left = Frame(typing_test , bg="red" , width=160 , height=400 , borderwidth=5)
button_frame_left.place(x=20 , y=250)

button_frame_left_label = Label(button_frame_left , text="Start Typing Here --->" , font="algerian 20 bold" , wraplength=100 , bg="black" , fg="white")
